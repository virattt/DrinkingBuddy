...
public class CustomBeerFragment extends DialogFragment {
	...
	public static CustomBeerFragment newInstance(Drink d) {
		CustomBeerFragment f = new CustomBeerFragment();
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		// Add action buttons
			...
			.setNegativeButton(R.string.cancel, new DialogInterface.OnClickListener() {
				...
				@Override
				public void onClick(DialogInterface dialog, int which) {
					CustomBeerFragment.this.getDialog().cancel();
				}
			});
